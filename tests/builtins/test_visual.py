...
from sym.builtins.visual import SymbolRender
...
def test_to_mmd_simple_tree(simple_sym_tree):
    a, b, c, d = simple_sym_tree
...
@pytest.mark.anyio
async def test_a_to_svg_simple_tree(simple_sym_tree):
    a, _, _, _ = simple_sym_tree
    try:
