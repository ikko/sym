...
[![CI](https://github.com/ikko/sym/actions/workflows/ci.yml/badge.svg)](https://github.com/ikko/sym/actions/workflows/ci.yml)
...
_**Disclaimer:**_
`«sym»` _is under development. Some features may missing, not fully implemented or undocumented. Contributions are always welcomed: fork and open a [pull request](https://github.com/ikko/sym/compare)!_
...
: Provides a comprehensive introduction to the `Symbol` library, guiding users through its fundamental concepts and practical applications. It demonstrates how `Symbol` facilitates the creation of clear, maintainable, and extensible symic models. This tutorial is designed for a broad audience, including software engineers, data scientists, and domain experts seeking to leverage symic representation in their projects.
