...
# apply_builtins() # Commented out for lazy loading and test compatibility
...
__all__ = [
    "Symbol", "s", "GraphTraversal",
    "freeze", "is_frozen",
    "add_time_objects", "subtract_time_objects",
    "a_process_batch", "process_batch",
    "Config",
    "builtins",
    "apply_builtins",
    "time_dim", "collections", "index", "path", "timeline", "visual",
