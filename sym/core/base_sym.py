...
class Symbol:
    ...
    # Basic comparison for numbered syms, more complex logic in sym.py
    def __lt__(self, other):
        # Check if both syms are in the numbered tree by searching for their positions
        ...
        raise TypeError("Unordered comparison not supported for non-numbered syms")

    # Basic JSON serialization, more complex logic in sym.py
    def __orjson__(self):
        return self.name

def _to_sym(x: Any) -> 'Symbol':
